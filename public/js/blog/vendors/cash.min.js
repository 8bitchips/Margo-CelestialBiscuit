!(function (t, e) {
  ...
  var s = document,
    ...
    f = /^\.[\w-]*$/,
    l = /^[\w-]*$/,
    d = (t.fn = t.prototype = { cash: !0, length: 0 });
  (d.init = function (e, n) {
    var i,
      r,
      u = [];
    if (!e) return this;
    if (((this.length = 1), "string" != typeof e))
      return e.cash ? e : ((this[0] = e), this);
    if ("<" === e.charAt(0) && ">" === e.charAt(e.length - 1) && e.length >= 3)
      u = t.parseHTML(e);
    else {
      if (((i = o.test(e)), (r = e.slice(1)), !n && i))
        return (this[0] = s.getElementById(r)), this;
      (n = t(n)[0] || s),
        (u = a.call(
          l.test(r)
            ? f.test(e)
              ? s.getElementsByClassName(r)
    ...
    (t.unique = function (e) {
      return t.merge(
        t(),
        a.call(e).filter(function (t, e, n) {
  ...
  d.extend({
    ...
    d.extend({
      ...
      index: function (e) {
        return e
          ? a.call(t(e).children()).indexOf(this[0])
          : a.call(t(this[0]).parent().children()).indexOf(this[0]);
      },
      last: function () {
        ...
        return "object" != typeof t
          ? e
            ? (this.each(function (n) {
              ...
              this)
            : u.getComputedStyle(this[0], null)[t]
          : void this.each(function (e) {
    ...
    d.extend({
      ...
      outerWidth: function (t) {
        return t === !0
          ? this[0].offsetWidth +
              (n(this, "margin-left") || n(this, "marginLeft") || 0) +
              (n(this, "margin-right") || n(this, "marginRight") || 0)
          : this[0].offsetWidth;
      },
      outerHeight: function (t) {
        return t === !0
          ? this[0].offsetHeight +
              (n(this, "margin-top") || n(this, "marginTop") || 0) +
              (n(this, "margin-bottom") || n(this, "marginBottom") || 0)
          : this[0].offsetHeight;
      },
      width: function () {
      ...
      return (
        this.each(function (i) {
          if (n) i.removeEventListener(e, n);
            ...
            for (var r in p[t(i).data("cshid")][e])
  ...
  return (
    d.extend({
      serialize: function () {
        ...
        for (e = i.elements.length - 1; e >= 0; e--)
          if (
            ((t = i.elements[e]),
            t.name && "file" !== t.type && "reset" !== t.type)
          )
            if ("select-multiple" === t.type)
              for (n = i.elements[e].options.length - 1; n >= 0; n--)
                t.options[n].selected &&
                  (r +=
                    "&" +
                    t.name +
                    "=" +
                    g(t.options[n].value).replace(/%20/g, "+"));
            else
              "submit" !== t.type &&
                "button" !== t.type &&
                (r += "&" + t.name + "=" + g(t.value).replace(/%20/g, "+"));
        return r.substr(1);
      },
      val: function (t) {
        return void 0 === t
    ...
    d.extend({
      ...
      html: function (e) {
        ...
        return "undefined" === e
          ? this[0].innerHTML
          : ((n = "object" == typeof e ? t(e)[0].outerHTML : e),
            this.each(function (t) {
      ...
      insertBefore: function (e) {
        return (
          t(e)[0].insertAdjacentHTML("beforebegin", this[0].outerHTML), this
        );
      },
      prepend: function (e) {
        return (
          t(this)[0].insertAdjacentHTML("afterBegin", t(e)[0].outerHTML), this
        );
      },
      prependTo: function (e) {
        return (
          t(e)[0].insertAdjacentHTML("afterBegin", this[0].outerHTML), this
        );
      },
      remove: function () {
        this.each(function (t) {
    ...
    d.extend({
      children: function (e) {
        return e
          ? t(this[0].children).filter(function (n) {
              return t.matches(n, e);
            })
